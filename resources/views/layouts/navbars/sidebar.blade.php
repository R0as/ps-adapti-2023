<div class="sidebar" data-color="adapti" data-background-color="white" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
    <!--
        ...
        <ul class="nav">
            ...
            <li class="nav-item {{ $activePage == 'user-management' || $activePage == 'log-list' ? ' active' : '' }}">
                ...
                <div class="collapse show" id="admin-collapse">
                    ...
                    <ul class="nav">
                        <li class="nav-item{{ $activePage == 'alunos-management' ? ' active' : '' }}">
                            <a class="nav-link" href="{{ route('aluno.index') }}">
                                <i class="sidebar-mini"><span class="material-icons">paid</span></i>
                                <span class="sidebar-normal">{{ __('Alunos') }} </span>
                            </a>
                        </li>
                    </ul>
                    <ul class="nav">
                        <li class="nav-item{{ $activePage == 'curso-management' ? ' active' : '' }}">
