...
<div class="row">
    ...
    <div class="classContratado">
        <input type="radio" id="contratado" name="contratado" value="1" data-expected-info="contratado" {{ isset($aluno) && $aluno->contratado== 1 ? 'Checked': '' }} class="form-control @error('contratado') is-invalid @enderror">
        <label for="contratado-yes">Sim</label>

        <input type="radio" id="contratado" name="contratado" value="0" data-expected-info="contratado" {{ isset($aluno) && $aluno->contratado== 0 ? 'Checked': '' }} class="form-control @error('contratado') is-invalid @enderror">
        <label for="contratado-yes">Não</label>
