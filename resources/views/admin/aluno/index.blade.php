                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Botao apagar -->
                                            <button type="button" title="{{ __('Delete') }}" data-toggle="modal" data-target="#modal-excluir" data-id="{{ $aluno->id }}" class="btn btn-danger">
                                                <i class="material-icons">close</i>
                                            </button>
                                            <!-- Botao visualizar -->
                                            <button type="button" title="{{ __('Visualizar') }}" data-toggle="modal" data-target="#modal-detalhes" data-id="{{ $aluno->id }}" class="btn btn-danger">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input type="text" id="detalhes-descricao" name="detalhes-descricao" class="form-control" readonly>
                        </div>
                        ...
                        <div class="form-group col-md-12 col-sm-12">
                            ...
                            <input type="text" id="detalhes-curso" name="detalhes-curso" class="form-control" readonly>
                        </div>
...
<script>
    ...
    $('#modal-detalhes').on('show.bs.modal', function(event) {
        ...
        $.getJSON(url, (resposta) => {
            ...
            const estaContratado = resposta.contratado === 1 ? "Sim" : 'Não';
            $("#detalhes-contratado").val(estaContratado);
